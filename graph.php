<?php
/* $Id: graph.php 2073 2009-09-15 21:39:35Z hawson $ */
...
// code change by saurabh.ve 
// start 
  if ( $_GET["percentile_value"] && $context == 'host' ) {
  $percentile_value = $_GET["percentile_value"] ; 
  $command .= " VDEF:sumpct=sum,";
  $command .= $_GET["percentile_value"] ; 
  $command .=  ",PERCENTNAN LINE1:sumpct#0000F2";
  $command .=  " GPRINT:'sumpct':'" ;
  $command .=  $_GET["percentile_value"] ;
  $command .= " Percentile Value\:%7.2lf%s'"; 
}

  $command .= " --color ARROW#00FF00 --color CANVAS#F0FFF0 --border 4 --dynamic-labels -i"; 
